...
public class BeforeRegistrationUserCheckActivity extends AppCompatActivity {
                    ...
                    call.enqueue(new Callback<BeforeRegistrationUserCheckAPI>() {
                        ...
                        public void onResponse(Call<BeforeRegistrationUserCheckAPI> call, Response<BeforeRegistrationUserCheckAPI> response)
                        {
                            ...
                            if (errorCode == 1)
                            {
                                ...
                                editor.apply();
                                startActivity(new Intent(BeforeRegistrationUserCheckActivity.this, BeforeRegistrationActivity.class));
                                finish();
                            }
                            else if (errorCode == 0)
                            {
                                Toasty.error(BeforeRegistrationUserCheckActivity.this, "This mobile number exists", Toasty.LENGTH_SHORT, true).show();
                            }
                        }
