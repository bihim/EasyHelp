...
public class ThanaAdapter extends RecyclerView.Adapter<ThanaAdapter.CountryViewHolder>
{
    ...
    public ThanaAdapter(ArrayList<CountryItems> arrayList, Context context)
    {
    ...
    public void onBindViewHolder(@NonNull CountryViewHolder holder, int position)
    {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                editor.putString("thana", selectedItems.getId());
                editor.apply();
