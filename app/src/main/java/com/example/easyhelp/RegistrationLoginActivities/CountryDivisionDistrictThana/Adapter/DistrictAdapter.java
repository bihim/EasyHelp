...
import com.example.easyhelp.RegistrationLoginActivities.CountryDivisionDistrictThana.Activity.ThanaActivity;
import com.example.easyhelp.RegistrationLoginActivities.CountryDivisionDistrictThana.Items.CountryItems;

import java.util.ArrayList;

public class DistrictAdapter extends RecyclerView.Adapter<DistrictAdapter.CountryViewHolder>
{
    ...
    public DistrictAdapter(ArrayList<CountryItems> arrayList, Context context)
    {
    ...
    public void onBindViewHolder(@NonNull CountryViewHolder holder, int position)
    {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                editor.putString("district", selectedItems.getId());
                editor.apply();
