...
public class NewsFragment extends Fragment
{
    ...
    private void newsDummyData()
    {
        ...
        newsItems.add(new NewsItems(R.drawable.facebook,"Facebook: The leading social site", "Facebook is the main social network over the internet. It has huge amount of members. Over a billion of data are passing through facebook."));
        newsItems.add(new NewsItems(R.drawable.android,"Android: Open Source OS","Android is one of the main os of this era. 78% of mobile devices are android. This os is based on linux kernel. Latest version of this os is android 10"));
        ...
        newsItems.add(new NewsItems(R.drawable.flutter,"Flutter: Cross platform development tool", "Flutter is an open-source UI software development kit created by Google. It is used to develop applications for Android, iOS, Windows, Mac, Linux, Google Fuchsia[5] and the web."));
        ...
        newsItems.add(new NewsItems(R.drawable.ios,"IOS: An apple os","iOS (formerly iPhone OS) is a mobile operating system created and developed by Apple Inc. exclusively for its hardware. It is the operating system that presently powers many of the company's mobile devices, including the iPhone, and iPod Touch; it also powered the iPad prior to the introduction of iPadOS in 2019."));
        newsItems.add(new NewsItems(R.drawable.linux,"Linux: An open source OS","Linux (/ˈlɪnəks/ (About this soundlisten) LIN-əks)[9][10] is a family of open source Unix-like operating systems based on the Linux kernel,[11] an operating system kernel first released on September 17, 1991, by Linus Torvalds.[12][13][14] Linux is typically packaged in a Linux distribution."));
        ...
        newsItems.add(new NewsItems(R.drawable.windows,"Windows: A shitty os","Microsoft Windows, commonly referred to as Windows, is a group of several proprietary graphical operating system families, all of which are developed and marketed by Microsoft. Each family caters to a certain sector of the computing industry."));
